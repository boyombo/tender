...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rating.tender'
        db.add_column(u'procurement_rating', 'tender',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['procurement.Tender']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rating.tender'
        db.delete_column(u'procurement_rating', 'tender_id')
