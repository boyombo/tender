...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Documentation.active'
        db.add_column(u'procurement_documentation', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Documentation.active'
        db.delete_column(u'procurement_documentation', 'active')
